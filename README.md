...
```
sudo pacman -S sway gammastep kitty swayidle swaync waybar wofi polkit-gnome thunar fish gnome-keyring seahorse xorg-xwayland gtk3 lxappearance python3 ninja meson cmake wl-clipboard rclone noto-fonts noto-fonts-emoji ttf-dejavu brightnessctl swaybg kanshi nwg-look
yay -S whitesur-gtk-theme whitesur-icon-theme librewolf-bin ttf-symbola swaylock-effects sway-audio-idle-inhibit-git
```
